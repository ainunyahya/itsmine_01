...
class ListTab6 extends StatefulWidget {
  final List<String> data;


  ListTab6({required this.data});

  @override
  State<ListTab6> createState() => _ListTab6State();
}

class _ListTab6State extends State<ListTab6> {
  ...
  Future _cancelData() async {
    try {
      final response = await http.get(
          Uri.parse('http://localhost/itsmine_app/orders/canceled.php'));
