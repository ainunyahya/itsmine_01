...
class ListTab1 extends StatefulWidget {
  ...
  ListTab1({required this.data});

  @override
  State<ListTab1> createState() => _ListTab1State();
}

class _ListTab1State extends State<ListTab1> {
  ...
  Future _cancelData() async {
    try {
      final response = await http.get(
          Uri.parse('http://localhost/itsmine_app/orders/today.php'));
